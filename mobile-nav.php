<!-- Mobile Nav -->
<div id="mobile_nav" class="global-nav-header-mobile overlay">
  <!-- Button to close the overlay navigation -->
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  <nav class="global-nav header-global-nav-mobile cf">
    <ul class="overlay-content">
      <li><a href="http://localhost/neri_gabe_equip_events/login.php">login</a></li>
      <li><a href="http://localhost/neri_gabe_equip_events/register.php">sign up</a></li>
